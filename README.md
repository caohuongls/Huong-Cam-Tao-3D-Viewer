...
<img width="1080" height="174" alt="image" src="https://github.com/user-attachments/assets/0cf3568f-d283-43e4-a0b0-de4f70cc1448" />
...
- **Nút màu** : Bật/Tắt texture trong trường hợp mẫu hàm có màu.
- **Chụp màn hình**. Chụp góc nhìn hiện tại lưu vào bộ nhớ đệm
- **Thêm file**. Bổ sung thêm file. Hỗ trợ định dạng : `html`, `stl`,`obj` .
- **Back to project** : Quay về menu dự án ( Trường hợp có đăng nhập)
---

## IV. Một Số Lưu Ý Quan Trọng

- **Thời gian lưu trữ**: Để tối ưu bộ nhớ server, các mẫu hàm sẽ được **tự động xóa sau 7-14 ngày** kể từ ngày upload. Hãy đảm bảo bạn đã hoàn tất công việc trước thời hạn này.
